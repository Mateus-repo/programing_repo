...
void getClassfications(double notasTemp[], int size);
double getTotal(double notasTemp[], int size);
void getAvg(double& media, double notasTemp[], int size);
void hold();
void endProgram();
...
int main() {
    ...
    double total = getTotal(notas, size);
...
void getAvg(double& media, double notasTemp[], int size) {
    double total = getTotal(notasTemp, size);
